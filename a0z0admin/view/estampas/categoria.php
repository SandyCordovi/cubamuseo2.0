...
<div class="cui_row admin-contenedor">
    <h1 class="admin-titulo">CATEGORIAS</h1>
    <div class="cui_row" style="margin-top: 20px;">
        <div class="btn_admin" onclick="cui_wnd._createWND_tamFijo('wnd/estampas/categoria_nuevo.php', 70, function(){CreateEditor();});">
            Nuevo
        </div>
        <div class="btn_admin" onclick="Refresh();">
            Refresh
        </div>
        <form id="ajaxform" action="service/estampas/categoria.php" method="post" class="admin_search_box">
...
$(document).ready(function() {    
    ...
    $.ajax(
    {
        url : 'service/estampas/categoria.php',
        type: "POST",
...
function Edit(id)
{
    cui_wnd._createWND_tamFijo('wnd/estampas/categoria_edit.php?id='+id, 70, function(){CreateEditor();});
}
...
{
    $.ajax({
        url : 'service/estampas/categoria_cmd.php',
        type: "POST",
        data : 'cmd=3&id='+id,
        success:function(data, textStatus, jqXHR)
        {
