...
<div class="cui_row admin-contenedor">
    <h1 class="admin-titulo">SECCIONES</h1>
    <div class="cui_row" style="margin-top: 20px;">
        <div class="btn_admin" onclick="cui_wnd._createWND_tamFijo('wnd/colecciones/seccion_nuevo.php', 70, function(){CreateEditor();});">
            Nuevo
        </div>
        <div class="btn_admin" onclick="Refresh();">
            Refresh
        </div>
        <form id="ajaxform" action="service/colleciones/seccion.php" method="post" class="admin_search_box">
...
$(document).ready(function() {    
    ...
    $.ajax(
    {
        url : 'service/colleciones/seccion.php',
        type: "POST",
...
function Edit(id)
{
    cui_wnd._createWND_tamFijo('wnd/colecciones/seccion_edit.php?id='+id, 70, function(){CreateEditor();});
}
...
{
    $.ajax({
        url : 'service/colleciones/seccion_cmd.php',
        type: "POST",
        data : 'cmd=3&id='+id,
        success:function(data, textStatus, jqXHR)
        {
