...
$item = getCategoriasSP();

?>
<script src="../lib/ckeditor/ckeditor.js" type="text/javascript"></script>

<div class="cui_row admin-contenedor">
    <h1 class="admin-titulo">MUESTRAS</h1>
    <div class="cui_row" style="margin-top: 20px;">
        <div class="btn_admin" onclick="cui_wnd._createWND_tamFijo('wnd/estampas/muestra_nuevo.php', 70, function(){CreateEditor();});">
            Nuevo
        </div>
        <div class="btn_admin" onclick="Refresh();">
            Refresh
        </div>
        <form id="ajaxform" action="service/estampas/muestra.php" method="post" class="admin_search_box">
...
function Edit(id)
{
    cui_wnd._createWND_tamFijo('wnd/estampas/muestra_edit.php?id='+id, 70, function(){CreateEditor();});
}
...
{
    $.ajax({
        url : 'service/estampas/muestra_cmd.php',
        type: "POST",
        data : 'cmd=3&id='+id,
        success:function(data, textStatus, jqXHR)
        {
...
{
    cui_wnd._createWND_tamFijo('wnd/estampas/muestra_additems.php?id='+id, 70);
}

function ChangeWord(id)
{
    cui_wnd._createWND_tamFijo('wnd/estampas/muestra_changeword.php?id='+id, 70);
}

function ChangeZip(id)
{
    cui_wnd._createWND_tamFijo('wnd/estampas/muestra_changezip.php?id='+id, 70);
}

function SetPrice(id)
{
    cui_wnd._createWND_tamFijo('wnd/estampas/muestra_price.php?id='+id, 50);
}
</script>