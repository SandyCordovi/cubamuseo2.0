    ...
    <form id="formWnd" action="service/estampas/estampa_cmd.php" method="post" enctype="multipart/form-data" class="cui_row">
        ...
        <div class="cui_row" style="margin-bottom:10px;">
            <select name="tematica_s" class="form" style="width: 500px; margin-bottom: 0; float:left;">
                    ...
                    <option value="<?php echo utf8_decode($categorias[$i]['id']); ?>" <?php echo $categorias[$i]['id']==$item['seccion'] ? 'selected' : ''; ?>><?php echo utf8_decode($categorias[$i]['titulo']); ?></option>
                    <?php } ?>
            </select>
        </div>
            ...
            $.ajax(
            {
                ...
                success:function(data, textStatus, jqXHR)
                {
                    ...
                    if(data.salida.msg == "ok"){
                        txt = 'La estampa se ha modificado exitosamente';
