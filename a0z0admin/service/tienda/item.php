...
$item = getItems($s, $b, $tem);
$total = getTotalItems($b, $tem);
    ...
    <?php for($i=0; $i<count($item); $i++){ ?>
        <tr>
              ...
              <td>
                  ...
                  <div class="cui_btn_blue" style="height: 25px; margin: 0; padding: 0 5px; margin: 0 5px; cursor: pointer; <?php echo $item[$i]['publicada']=="publicado" ? "" : "background-color: red;" ?>" data-public="<?php echo $item[$i]['publicada'] ?>" onclick="PublicUnp(<?php echo $item[$i]['id'] ?>, this);"><?php echo $item[$i]['publicada']=="publicado" ? "Publish" : "Unpublish" ?></div>
              </td>
