...
<div class="cui_row admin-contenedor">
    <h1 class="admin-titulo">TEMATICAS</h1>
    <div class="cui_row" style="margin-top: 20px;">
        <div class="btn_admin" onclick="cui_wnd._createWND_tamFijo('wnd/tienda/tematica_nuevo.php', 70, function(){});">
            Nuevo
        </div>
        <div class="btn_admin" onclick="Refresh();">
            Refresh
        </div>
        <form id="ajaxform" action="service/tienda/tematica.php" method="post" class="admin_search_box">
...
$(document).ready(function() {    
    ...
    $.ajax(
    {
        url : 'service/tienda/tematica.php',
        type: "POST",
...
function Edit(id)
{
    cui_wnd._createWND_tamFijo('wnd/tienda/tematica_edit.php?id='+id, 70, function(){CreateEditor();});
}
...
{
    $.ajax({
        url : 'service/tienda/tematica_cmd.php',
        type: "POST",
        data : 'cmd=3&id='+id,
        success:function(data, textStatus, jqXHR)
        {
